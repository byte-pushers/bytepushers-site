...
__adapter__.addStepDefinitions(scenario => {
  ...
  scenario.When(/^I generate generate an inquiry toJSON$/, (callback) => {
    ...
    if (
			json === '{"id": "1","address": {"id": "1","city": "fayetteville","country": "US","street": "AR","state": "Example St.","zip": "72703"},"description": "sample desc.","company": "BP","email": "jared.ramirez@bytepushes.software","funded": "false","nameFirst": "jared","nameLast": "ramrez","phoneNumber": "0000000000","projectSize": "small","projectType": "personal"}'
		) {
      callback();
    } else {
